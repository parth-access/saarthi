...
import { User, Bell, Shield, Camera, ArrowLeft, Loader2, Save } from "lucide-react";
                  ...
                  {[
                    ...
                    <div key={item.id} className="flex items-start justify-between p-4 rounded-2xl bg-[#FFFBE7]/50 border border-primary/5 hover:border-primary/10 transition-colors">
                      ...
                      <button
                        ...
                        className={`w-11 h-6 rounded-full transition-colors relative cursor-pointer ${notifications[item.id as keyof typeof notifications] ? "bg-[#E6A520]" : "bg-primary/20"}`}
                      >
              ...
              <div className="space-y-8 font-sans">
                ...
                <div className="p-5 rounded-2xl border border-primary/10 bg-white">
                  <div className="flex items-center justify-between">
                    ...
                    <Button variant="outline" size="sm" className="cursor-pointer">Update Password</Button>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl border border-red-100 bg-red-50/50">
                  ...
                  <Button variant="outline" size="sm" className="border-red-200 text-red-700 hover:bg-red-100 cursor-pointer">Delete Account</Button>
                </div>
              </div>
            )}
