...
describe('BookingStateMachine and Booking Entity', () => {
  ...
  describe('Invalid Transitions', () => {
    it('should throw InvalidBookingTransitionError for Completed → Draft', () => {
    ...
    it('should throw InvalidBookingTransitionError for Cancelled → Confirmed', () => {
    ...
    it('should throw InvalidBookingTransitionError for Expired → Payment Started', () => {
