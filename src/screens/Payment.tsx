...
export const Payment: React.FC = () => {
  ...
  const handlePayment = async () => {
    ...
    const options = {
      ...
      image: '/favicon.ico', // Update to logo if available
        ...
        <div className="bg-white rounded-[2rem] p-6 sm:p-10 shadow-xl border border-[#E6A520]/20">
          ...
          <div className="flex items-center gap-4 mb-8 pb-8 border-b border-gray-100">
             ...
             <div>
                ...
                <div className="text-3xl font-serif text-gray-900">₹{booking.paymentAmount || 1500}</div>
             </div>
          </div>
          ...
          <button
            ...
            disabled={verifying}
            className="w-full h-14 bg-[#E6A520] hover:bg-[#C48B1A] disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl font-medium tracking-wide transition-all shadow-lg shadow-[#E6A520]/20 flex items-center justify-center gap-2"
          >
            {verifying ? (
