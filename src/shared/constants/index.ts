 ...
 * the same 45-minute block (googleCalendarService.ts) — this constant is the
 ...
 * Saarthi's 45-minute sessions are booked on the matching 45-minute cadence, so
 * a 09:00 session occupies 09:00–09:45 and a 09:45 session occupies 09:45–10:30.
 */
